...
/*
	...
	$config->set('dbhost', 'internal-db.s178119.gridserver.com');
	$config->set('dbname', 'db178119_betoayesa');
	$config->set('dbuser', 'db178119');
	$config->set('dbpass', 'tryagain22');
	...
	$config->set('base_title','Cintia');

	$config->set('seo_title','Cintia'); 
